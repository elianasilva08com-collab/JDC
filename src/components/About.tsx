        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg leading-relaxed">
              A <strong>JDC Cacambas</strong> é uma empresa especializada em locações, transportes e coletas de entulhos.
            </p>
            <p className="text-lg leading-relaxed">
              Fundada em 2011, com sede em São Paulo, atendemos toda a região com profissionalismo, agilidade e comprometimento com a satisfação dos nossos clientes.
            </p>
            <p className="text-lg leading-relaxed">
            ...
            <p className="text-lg leading-relaxed">
              Contamos com uma equipe qualificada e equipamentos modernos para garantir a excelência em todos os serviços prestados. Com mais de 14 anos de experiência no mercado, construímos nossa reputação baseada na qualidade e confiabilidade.
            </p>
            <button
          ...
          <div className="rounded-xl overflow-hidden shadow-2xl">
            <img
              ...
              alt="Caminhão da JDC Cacambas com containers para coleta de entulhos"
