...
const Footer: React.FC = () => {
  ...
  const footerSections = [
    {
      title: 'JDC Cacambas',
      content: 'Oferecendo soluções em locações, transportes e coletas de entulhos com qualidade e responsabilidade desde 2011.',
      social: true,
    },
    {
      title: 'Links Rápidos',
    ...
    },
    {
      ...
      contactInfo: [
        ...
        { icon: Mail, text: 'contatos@jdc.com.br' },
        { icon: MapPin, text: 'Rua Forte do Limoeiro, 33 - Vila Antonieta, São Paulo - SP, CEP: 03475-010' },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="text-center text-gray-400 text-sm">
            <p>&copy; 2024 JDC Cacambas - Todos os direitos reservados</p>
          </div>
        </div>
      </div>
    </footer>
