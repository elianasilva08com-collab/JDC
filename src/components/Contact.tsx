...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Olá! Gostaria de solicitar um orçamento para os serviços da JDC Cacambas.
...
Aguardo retorno. Obrigado!`;
    ...
    const whatsappUrl = `https://api.whatsapp.com/send/?phone=5511519274478&text=${encodedMessage}&type=phone_number&app_absent=0`;
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'E-mail',
      content: ['contatos@jdc.com.br'],
    },
    {
      icon: MapPin,
      title: 'Endereço',
      content: ['Rua Forte do Limoeiro, 33 - Vila Antonieta', 'São Paulo - SP, CEP: 03475-010'],
    },
    {
      icon: Clock,
